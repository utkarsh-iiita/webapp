...
import { Box, CircularProgress, Container, Divider, IconButton, TextField, ToggleButton, Tooltip, Typography } from "@mui/material";
...
export default function UserProfile() {
  ...
  const { data: profile, isLoading, isError } = api.student.getStudentProfile.useQuery();
        ...
        <>
          ...
          <Container className="flex justify-end">
            <LoadingButton
              ...
              onClick={() => updateDetails(phone || profile.phone, email || profile.email)}
            >
              Save Changes
            </LoadingButton>
          </Container>
